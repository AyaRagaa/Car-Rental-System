<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO customer (user_id, first_name, last_name, phone_number, email, password, isAdmin, gender, Bdate) VALUES ('$username', '$firstName', '$lastName','$phoneNumber', '$email', '$encrypted', 'false', '$gender', '$bdate')";
